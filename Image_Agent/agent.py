...
agent = Agent(
    ...
    model=litellm_model,
    instruction="""
You are an agent with specialty in image documents. You primarily deal with .png, .jpg, .jpeg, .webp, and .tiff.
Your primary purpose is to extract text from specified image types, vectorize it and store them in 
